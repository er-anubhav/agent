...
export const RefreshCwIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M4.67695 3.67695C5.79359 2.56031 7.32032 1.875 9 1.875C12.5208 1.875 15.375 4.72917 15.375 8.25C15.375 8.66421 15.0392 9 14.625 9C14.2108 9 13.875 8.66421 13.875 8.25C13.875 5.55762 11.6924 3.375 9 3.375C7.73567 3.375 6.57692 3.85547 5.73633 4.69629L6.84375 5.80371C7.15137 6.11133 6.9375 6.625 6.5 6.625H2.75C2.33579 6.625 2 6.28921 2 5.875V2.125C2 1.6875 2.51367 1.47363 2.82129 1.78125L4.67695 3.67695ZM11.3229 11.3229C10.2064 12.4396 8.67968 13.125 7 13.125C3.47917 13.125 0.625 10.2708 0.625 6.75C0.625 6.33579 0.960786 6 1.375 6C1.78921 6 2.125 6.33579 2.125 6.75C2.125 9.44238 4.30762 11.625 7 11.625C8.26433 11.625 9.42308 11.1445 10.2637 10.3037L9.15625 9.19629C8.84863 8.88867 9.0625 8.375 9.5 8.375H13.25C13.6642 8.375 14 8.71079 14 9.125V12.875C14 13.3125 13.4863 13.5264 13.1787 13.2188L11.3229 11.3229Z"
      fill="currentColor"
    />
  </svg>
);
